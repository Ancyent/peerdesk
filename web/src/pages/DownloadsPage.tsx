...
import { OS_TABS, assetLabel, AGENT_ARGS, LINUX_DISTROS, AGENT_UNINSTALL_LINUX, AGENT_UNINSTALL_WINDOWS, formatSize, uninstallHint, DEFAULT_LINUX_PACKAGE, type OsId } from './downloads/osData';
                      ...
                      <div style={{ fontSize: 11, color: 'var(--text-2)', background: 'var(--bg-hover)', border: '1px solid var(--border-dim)', borderRadius: 6, padding: '8px 10px', lineHeight: 1.5 }}>
                        ℹ️ <Trans
                          ...
                          components={{
                            ...
                            uninstallCmd: <code>{`apt/dnf/zypper remove ${release.linux_package || DEFAULT_LINUX_PACKAGE}`}</code>,
