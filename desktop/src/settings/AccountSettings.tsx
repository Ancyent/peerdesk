...
export function AccountSettings() {
  ...
  return (
    <div style={{ padding: '20px 24px' }}>
      ...
      <div style={{ fontSize: 10, color: '#b3bdca', letterSpacing: 1, fontWeight: 600, marginBottom: 10, paddingBottom: 6, borderBottom: '1px solid #21262d', textTransform: 'uppercase' }}>Device Info</div>

      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 0', borderBottom: '1px solid #1c2128' }}>
        <div style={{ fontSize: 12, color: '#b3bdca' }}>Peer ID</div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', padding: '10px 0', borderBottom: '1px solid #1c2128' }}>
        <div style={{ fontSize: 12, color: '#b3bdca' }}>Platform</div>
        <div style={{ fontSize: 12, color: '#e6ebf1' }}>{navigator.platform || 'Unknown'}</div>
      </div>
      <div style={{ display: 'flex', justifyContent: 'space-between', padding: '10px 0' }}>
        <div style={{ fontSize: 12, color: '#b3bdca' }}>Agent version</div>
        <div style={{ fontSize: 12, color: '#e6ebf1' }}>{version ? `v${version}` : '—'}</div>
      </div>

      <div style={{ marginTop: 20 }}>
        <div style={{ fontSize: 10, color: '#b3bdca', letterSpacing: 1, fontWeight: 600, marginBottom: 10, paddingBottom: 6, borderBottom: '1px solid #21262d', textTransform: 'uppercase' }}>Password</div>
        ...
        {newPwd && (
          <div style={{ marginTop: 12, background: '#0a2a2e', border: '1px solid #26c6da', borderRadius: 6, padding: 12 }}>
            <div style={{ fontSize: 10, color: '#b3bdca', marginBottom: 6 }}>New password — copy it now:</div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
