...
export function GeneralSettings({ settings, updateSetting }: Props) {
  return (
    <div style={{ padding: '20px 24px' }}>
      ...
      <div style={{ fontSize: 10, color: '#8b949e', letterSpacing: 1, fontWeight: 600, marginBottom: 10, paddingBottom: 6, borderBottom: '1px solid #21262d', textTransform: 'uppercase' }}>Startup</div>
      {([
